...
public:
    ...
    int CanDelInventoryItemByKindNQty(int a2, std::uint16_t a3);
    ...
    int DelInventoryItemKind(std::uint16_t a2, std::uint16_t a3, cltItemList* a4, std::uint8_t* a5);
    ...
    int IsThereInventoryItemByKindNQty(int a2, std::uint16_t a3);
    ...
    int GetItemSlotIndexRangeByItemKind(std::uint16_t a2, int* a3, int* a4);
    void GetItemSlotIndexRangeByItemType(int a2, int* a3, int* a4);
    int GetEmptyItemSlotNum(int a2);
    int IsValidItemSlotIndex(int a2);
    int IsValidItemSlotIndex(int a2, int a3);
    int IsIdenticalItemTypeSlotIndex(int a2, int a3);
    void FillOutInventoryInfo(CMofMsg* a2);
    strInventoryItem* EquipedItem(std::uint16_t a2, std::int16_t a3, int a4, int a5);
    int CanIncreaseGenericBagNum();
    ...
    int ISGetItemID(unsigned int a2, unsigned int* a3, unsigned int* a4);
