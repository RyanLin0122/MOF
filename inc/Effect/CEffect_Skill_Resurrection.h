...
/**
 * @class CEffect_Skill_Resurrection
 * @brief 代表復活技能的視覺特效。
 *
 * 繼承自 CEffectBase，是一個在固定座標播放的一次性動畫特效，
 * 其外觀會根據技能等級變化。
 */
class CEffect_Skill_Resurrection : public CEffectBase {
public:
    CEffect_Skill_Resurrection();
    virtual ~CEffect_Skill_Resurrection();
...
protected:
    // --- 成員變數 (根據 Effectall.c @ 0x00533C90 推斷) ---
