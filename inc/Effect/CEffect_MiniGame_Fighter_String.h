...
/**
 * @class CEffect_MiniGame_Fighter_String
 * @brief 在小遊戲中顯示格鬥家相關提示文字的程序化動畫特效。
 */
class CEffect_MiniGame_Fighter_String : public CEffectBase {
public:
    CEffect_MiniGame_Fighter_String();
    virtual ~CEffect_MiniGame_Fighter_String();
...
private:
    // --- 成員變數 (根據 Effectall.c @ 0x00538180 推斷) ---
