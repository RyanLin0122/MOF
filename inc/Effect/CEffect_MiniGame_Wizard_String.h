...
/**
 * @class CEffect_MiniGame_Wizard_String
 * @brief 在小遊戲中顯示魔法師相關提示文字的程序化動畫特效。
 */
class CEffect_MiniGame_Wizard_String : public CEffectBase {
public:
    CEffect_MiniGame_Wizard_String();
    virtual ~CEffect_MiniGame_Wizard_String();
...
private:
    // --- 成員變數 (根據 Effectall.c @ 0x00538A10 推斷) ---
