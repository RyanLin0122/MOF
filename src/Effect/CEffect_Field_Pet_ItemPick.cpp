...
#include "Effect/CEffect_Field_Pet_ItemPick_Sub.h" // 包含子特效定義
...
extern int SETTING_FRAME; // 假設為一個常數，例如 5
...
void CEffect_Field_Pet_ItemPick::SetEffect(D3DXVECTOR2* pStartPosition, unsigned int dwOwnerAccountID)
{
    ...
    m_fCurrentPosY = pStartPosition->y - 50.0f; // 物品從地面上方一點開始
    m_dwOwnerAccountID = dwOwnerAccountID;
    m_pOwnerPet = nullptr; // 初始時先設為空
}
