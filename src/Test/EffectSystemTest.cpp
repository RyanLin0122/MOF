...
void EffectSystemTest::InitializeRenderTestCases()
{
    m_renderTestCases = {
        ...
        { "Field_Miss", &EffectSystemTest::SpawnFieldMissEffect },
        { "Skill_Hit", &EffectSystemTest::SpawnSkillHitEffect },
        { "Use_Hit", &EffectSystemTest::SpawnUseHitEffect },
        { "MiniGame_Archer_String", &EffectSystemTest::SpawnMiniGameArcherStringEffect },
        { "MiniGame_Fighter_Break", &EffectSystemTest::SpawnMiniGameFighterBreakEffect },
        { "MiniGame_Fighter_String", &EffectSystemTest::SpawnMiniGameFighterStringEffect },
...
{
    if (!m_pCaster) return;
    CEffect_Field_ItemPick_Sub* pEffect = new CEffect_Field_ItemPick_Sub();
    float x = 0.0f, y = 0.0f;
    GetCasterPosition(x, y);
...
{
    if (!m_pCaster) return;
    CEffect_Field_Pet_ItemPick_Sub* pEffect = new CEffect_Field_Pet_ItemPick_Sub();
    float x = 0.0f, y = 0.0f;
    GetCasterPosition(x, y);
    pEffect->SetEffect(x, y, false);
    CEffectManager::GetInstance()->BulletAdd(pEffect);
